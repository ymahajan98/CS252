...
var UserLoginPage = /** @class */ (function () {
    ...
    UserLoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-user-login',template:/*ion-inline-start:"/home/yash/Downloads/CS252/CabRental/src/pages/user-login/user-login.html"*/'<!--\n  Generated template for the UserLoginPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Login</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <form (ngSubmit)="openUSSL()" [formGroup]="loginForm">\n       \n     <ion-list inset>\n\n      <ion-item  [ngClass]="{ invalid: emailErrors.hasError(\'*\', [\'touched\', \'dirty\']) }">\n        <ion-label stacked>E-Mail</ion-label>\n        <ion-input type="text" formControlName="email"></ion-input>\n      </ion-item>\n\n      <div ngxErrors="email" #emailErrors="ngxErrors">\n        <div [ngxError]="[\'email\', \'required\']" [when]="[\'touched\', \'dirty\']">It should be a valid email</div>\n      </div>\n\n      <ion-item [ngClass]="{ invalid: passwordErrors.hasError(\'*\', [\'touched\']) }">\n        <ion-label stacked>Password</ion-label>\n        <ion-input type="password" formControlName="password"></ion-input>\n      </ion-item>\n\n      <div ngxErrors="password" #passwordErrors="ngxErrors">\n        <div [ngxError]="[\'minlength\', \'required\']" [when]="[\'touched\']">It should be at least 5 characters</div>\n      </div>\n\n      <div class="form-error">{{loginError}}</div>\n\n    </ion-list>\n      <ion-row center>\n      	<ion-col text-center>\n      		<button ion-button color="dark" round type="submit" [disabled]="!loginForm.valid">LOGIN</button>\n      	</ion-col>\n      </ion-row>\n\n      <ion-row center>\n        <ion-col text-center>\n          <button ion-button color="dark" round (click)="reset()">Reset Password</button>\n        </ion-col>\n      </ion-row>\n        \n  </form>\n  <ion-row center>\n    <ion-col text-center>\n      <button ion-button color="dark" round (click)="openUSL()">SIGNUP</button>\n    </ion-col>\n  </ion-row>\n</ion-content>\n'/*ion-inline-end:"/home/yash/Downloads/CS252/CabRental/src/pages/user-login/user-login.html"*/,
        }),
...
var UserSignupPage = /** @class */ (function () {
    ...
    UserSignupPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-user-signup',template:/*ion-inline-start:"/home/yash/Downloads/CS252/CabRental/src/pages/user-signup/user-signup.html"*/'<!--\n  Generated template for the UserSignupPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Signup</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <form (ngSubmit)="signup(confirm)" [formGroup]="form">\n\n     <ion-list>\n\n      <ion-item [ngClass]="{ invalid: emailErrors.hasError(\'*\', [\'touched\']) }">\n        <ion-label stacked>E-Mail</ion-label>\n        <ion-input type="text" formControlName="email"></ion-input>\n      </ion-item>\n\n      <div ngxErrors="email" #emailErrors="ngxErrors">\n        <div [ngxError]="[\'email\', \'required\']" [when]="[\'touched\']">It should be a valid email</div>\n      </div>\n\n      <ion-item [ngClass]="{ invalid: passwordErrors.hasError(\'*\', [\'touched\']) }">\n        <ion-label stacked>Password</ion-label>\n        <ion-input type="password" formControlName="password"></ion-input>\n      </ion-item>\n\n      <div ngxErrors="password" #passwordErrors="ngxErrors">\n        <div [ngxError]="[\'minlength\', \'required\']" [when]="[\'touched\']">It should be at least 6 characters</div>\n      </div>\n\n      <ion-item>\n        <ion-label stacked>Confirm Password</ion-label>\n        <ion-input type="password" [(ngModel)]="confirm" [ngModelOptions]="{standalone:true}"></ion-input>\n      </ion-item>\n\n    </ion-list>\n\n    <div class="form-error">{{signupError}}</div>    \n\n    <ion-row center>\n    	<ion-col text-center>\n    		<button ion-button color="dark" round type="submit" [disabled]="!form.valid">PROCEED</button>\n    	</ion-col>\n    </ion-row>\n\n  </form>\n</ion-content>\n'/*ion-inline-end:"/home/yash/Downloads/CS252/CabRental/src/pages/user-signup/user-signup.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_3__services_auth_service__["a" /* AuthService */]])
...
var RideMapPage = /** @class */ (function () {
    ...
    RideMapPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-ride-map',template:/*ion-inline-start:"/home/yash/Downloads/CS252/CabRental/src/pages/ride-map/ride-map.html"*/'<!--\n  Generated template for the RideMapPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header no-border>\n\n  <ion-navbar transperant>\n    <ion-title>Rides...</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n    <div id="map"></div>\n</ion-content>\n'/*ion-inline-end:"/home/yash/Downloads/CS252/CabRental/src/pages/ride-map/ride-map.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* LoadingController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__services_driver_service__["a" /* DriverService */]])
    ], RideMapPage);
    return RideMapPage;
}());
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/yash/Downloads/CS252/CabRental/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/yash/Downloads/CS252/CabRental/src/app/app.html"*/
        }),
